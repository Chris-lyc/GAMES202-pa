...
GAMES202Main();
//整个项目的main index.html为前端显示，其他工作都由engine.js开始
//逻辑主入口，设置了显示环境，以及 Camera 等设置。添加了 Light 和 场景中的 Objects，在逻辑的最后面创建了 UI
function GAMES202Main() {
	...
	function mainLoop(now) {
		...
		renderer.render();
		requestAnimationFrame(mainLoop);// HTML5 提供的一个专门用于处理动画 API
	}
