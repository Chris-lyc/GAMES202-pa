//FBO:Frame Buffer Object：FrameBuffer 的封装，在构造函数中创建了一个 FrameBuffer 并进行绑定和设置
//虽然在 DirectionalLights 和 PointLight.js 中都创建了 FBO，但是 PointLight 实际上并没有使用，
//所以整个框架只创建了1个 FBO，在 ShadowMaterial 构造时传入到基类 Material 中，也就是说所有的阴影都会绘制到这一个 FrameBuffer中。
class FBO{
    constructor(gl){
